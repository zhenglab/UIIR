...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--dataset_name',type=str, default='uieb', help='path to our dataset IHD')
        parser.add_argument('--unaligned_dataset',type=str, default='euvp', help='path to our dataset IHD')
        parser.add_argument('--dataset_root',type=str, default='../../datasets/', help='path to our dataset IHD')
        parser.add_argument('--dataset_dir_name',type=str, default='raw-890', help='path to our dataset IHD')
        ...
        parser.add_argument('--num_pos_feats', type=int, default=0, help='num_pos_feats')
        parser.add_argument('--feature_h', type=int, default=0, help='num_pos_feats')

        parser.add_argument('--gradient_loss', action='store_true', help="reflectance use nce(H,R)")

        parser.add_argument('--D_loss_mode', type=str, default='cos', help='cos || acos')
        parser.add_argument('--loss_D_no_fake', action='store_true', help='tr_enc_use_mask')



        parser.add_argument('--nce_layers', type=str, default='0,4,7,10,12', help='compute NCE loss on which layers')
